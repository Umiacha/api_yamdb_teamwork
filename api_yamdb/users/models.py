...
# 2) Исправить json, выдаваемый на users/me.
# 3) Проверить пермишены в действии.
# 4) Проект переставлен на русский язык, поэтому надо сделать локализацию для всех своих моделей и полей.
