...
1) Просто создать CustomUser(django.contrib.auth.User) и добавить ему два поля дополнительно?
2) Как обеспечить role='admin' для суперпользователя при любых обстоятельствах?
